...
const Button = () => {
  const copyToClipboard = () => {
    const link = 'https://www.instagram.com/jaice.joshy?igsh=NTF5Njhrcnh6dm9r'; // Replace with your link
...
<button
  class="relative inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-lg--host p-[1px] focus:outline-none" onClick={copyToClipboard}
>
  <span
